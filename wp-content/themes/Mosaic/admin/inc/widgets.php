...
*********************************************************************************************/
function bestthemeframework_widgets_init() {
	
	register_sidebar( array (
    'name' => __( 'Sidebar Widgets', 'bestthemeframework' ),
    'id' => 'primary',
    ...
    register_sidebar( array (
    'name' => __( 'Footer Widgets', 'bestthemeframework' ),
    'id' => 'footer',
...
add_action( 'init', 'bestthemeframework_widgets_init' );
...
*********************************************************************************************/
class bestthemeframework_twitter_widget extends WP_Widget {
    function __construct() {
        parent::__construct(false, $name = 'BestTheme Framework Twitter Widget', array( 'description' => 'BestTheme Framework Twitter profile widget for your site.' ) );
    }
    ...
    function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_id( 'widget_title' ); ?>"><?php _e('Widget Title:', 'bestthemeframework') ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'screen_name' ); ?>"><?php _e('Screen name:', 'bestthemeframework') ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'num_tweets' ); ?>"><?php _e('Number of Tweets:', 'bestthemeframework') ?></label>
...
?>
        ...
        <!-- end twitter widget -->
		<a class="twitter-action" href="http://twitter.com/<?php echo $instance['screen_name']; ?>"><?php _e('Follow Us on Twitter! ', 'bestthemeframework') ?> &raquo; </a>
...
add_action( 'widgets_init', create_function( '', 'return register_widget( "bestthemeframework_twitter_widget" );' ) );
?>