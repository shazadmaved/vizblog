...
*********************************************************************************************/
function bestthemeframework_header_init() {
    if (!is_admin()) {
...
add_action('init', 'bestthemeframework_header_init');
...
*********************************************************************************************/
function bestthemeframework_mediauploader_init() {
    if (is_admin()) {
    wp_enqueue_script('media-upload');
	wp_enqueue_script('thickbox');
	wp_enqueue_style('thickbox');
	wp_enqueue_script('bestthememediauploader', get_template_directory_uri().'/admin/js/bestthememediauploader.js', false, '2.1', true);
}
}
add_action('init', 'bestthemeframework_mediauploader_init');
...
*********************************************************************************************/
function bestthemeframework_custom_shortcut_favicon() {
...
add_action('wp_head', 'bestthemeframework_custom_shortcut_favicon');
...
*********************************************************************************************/
function bestthemeframework_contactform_init() {
...
add_action('template_redirect', 'bestthemeframework_contactform_init');
...
*********************************************************************************************/
function bestthemeframework_analytics(){
	$output = of_get_option('stats');
	if ( $output <> "" )
	echo stripslashes($output) . "\n";
}
add_action('wp_footer','bestthemeframework_analytics');
?>