	  ...
	  <?php settings_fields('optionsframework'); ?>
        ...
        <div id="header">
          <div class="logo">
            ...
            <div class="btauthor">
                            <h2>
                                <a href="http://besttheme.net">
                                    <?php esc_attr_e( 'A Theme by','bhardwajaframework' ); ?> 
                                    <strong>
                                        <?php esc_attr_e( 'besttheme.net','bhardwajaframework' ); ?>
                                    </strong>
                                </a>
                            </h2>
                        </div>
        ...
        <div class="of_admin_bar">
			<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options','bestthemeframework' ); ?>" />
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults','bestthemeframework' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!','bestthemeframework' ) ); ?>' );" />
		</div>
<div class="clear"></div>
	</form>
</div> <!-- / #container -->
...
function optionsframework_validate($input) {
	...
	if (!empty($_POST['reset'])) {
		...
		if (delete_option($option_name) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'bestthemeframework' ), 'updated fade' );
		}
	}
	...
	if ( isset($clean) ) {
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'bestthemeframework' ), 'updated fade' );
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
		'parent' => 'appearance',
		'id' => 'of_theme_options',
		'title' => __( 'Theme Options','bestthemeframework' ),
